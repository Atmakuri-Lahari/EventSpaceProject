...
const UpdateEventSpace = () => {
    ...
    return (
        <div className="container mt-5">
            <h2 className="text-center">Update Event Space Details</h2>
            <p className="text-muted text-center">Modify the details of your event space as needed.</p>
...
export default UpdateEventSpace;
